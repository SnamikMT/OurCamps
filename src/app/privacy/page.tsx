...
export const metadata: Metadata = {
  ...
  description:
    'Информация об обработке персональных данных в системе управления детскими лагерями «Наши лагеря»',
  openGraph: {
    title: 'Политика конфиденциальности - Наши лагеря',
    description:
      'Информация об обработке персональных данных в системе управления детскими лагерями «Наши лагеря»',
      ...
      <main className="flex-grow py-10 md:py-16 lg:py-24">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h1 className="font-bounded text-2xl sm:text-3xl md:text-4xl font-bold mb-6 md:mb-8 text-center">
            ...
            <div className="bg-white rounded-3xl shadow-card p-5 sm:p-6 md:p-8 mb-6 md:mb-8">
              ...
              <div className="space-y-5 md:space-y-6 text-gray-700 text-sm sm:text-base">
                ...
                <h2 id="section1" className="font-bounded text-lg sm:text-xl font-bold mt-6 md:mt-8 mb-3 md:mb-4">
                  1. Общие положения
                </h2>
                ...
                <p>
                  ...
                  данных, предпринимаемые ООО «НАШИ ЛАГЕРЯ» (далее — Оператор).
                </p>
                ...
                <h2 id="section2" className="font-bounded text-lg sm:text-xl font-bold mt-6 md:mt-8 mb-3 md:mb-4">
                ...
                <h2 id="section3" className="font-bounded text-lg sm:text-xl font-bold mt-6 md:mt-8 mb-3 md:mb-4">
                ...
                <h2 id="section4" className="font-bounded text-lg sm:text-xl font-bold mt-6 md:mt-8 mb-3 md:mb-4">
                ...
                <h2 id="section5" className="font-bounded text-lg sm:text-xl font-bold mt-6 md:mt-8 mb-3 md:mb-4">
                ...
                <h2 id="section6" className="font-bounded text-lg sm:text-xl font-bold mt-6 md:mt-8 mb-3 md:mb-4">
                ...
                <h2 id="section7" className="font-bounded text-lg sm:text-xl font-bold mt-6 md:mt-8 mb-3 md:mb-4">
                ...
                <h2 id="section8" className="font-bounded text-lg sm:text-xl font-bold mt-6 md:mt-8 mb-3 md:mb-4">
                ...
                <p>
                  ...
                  <a href="mailto:info@ourcamps.ru" className="text-primary-blue">info@ourcamps.ru</a> с пометкой
                ...
                <p>
                  ...
                  обязуется знакомиться с указанными документами. Оператор не несет ответственность за действия третьих лиц,
                ...
                <p>
                  8.10. Сбор статистической информации с помощью Яндекс.Метрики. Оператор использует сервис веб-аналитики
                  Яндекс.Метрика, предоставляемый компанией ООО «ЯНДЕКС», 119021, Россия, Москва, ул. Л. Толстого, 16.
                  Яндекс.Метрика использует технологию &quot;cookie&quot; (небольшие текстовые файлы, размещаемые на
                  устройстве Пользователя) для анализа использования сайта. Собранная с помощью cookie информация (включая
                  IP-адрес) передается и хранится на серверах Яндекса. Яндекс использует эту информацию для оценки использования
                  сайта, составления отчетов о его активности и предоставления других услуг, связанных с анализом интернет-активности
                  и использования сайта. Яндекс также может передавать эту информацию третьим лицам в случаях, предусмотренных
                  законодательством или когда третьи лица обрабатывают информацию по поручению Яндекса. Пользователь может
                  отказаться от использования cookie, выбрав соответствующие настройки в браузере, однако это может повлиять
                  на работу некоторых функций сайта. Используя сайт, Пользователь соглашается на обработку своих данных Яндексом
                  в порядке и целях, указанных выше.
                </p>

                <h2 id="section9" className="font-bounded text-lg sm:text-xl font-bold mt-6 md:mt-8 mb-3 md:mb-4">
                ...
                <h2 id="section10" className="font-bounded text-lg sm:text-xl font-bold mt-6 md:mt-8 mb-3 md:mb-4">
                ...
                <h2 id="section11" className="font-bounded text-lg sm:text-xl font-bold mt-6 md:mt-8 mb-3 md:mb-4">
                ...
                <h2 id="section12" className="font-bounded text-lg sm:text-xl font-bold mt-6 md:mt-8 mb-3 md:mb-4">
                ...
                <p>
                  ...
                  <a href="mailto:info@ourcamps.ru" className="text-primary-blue">info@ourcamps.ru</a>.
                </p>
                ...
                <p>
                  ...
                  <a href="https://нашилагеря.рф/privacy" className="text-primary-blue">
                    https://нашилагеря.рф/privacy
                  </a>.
                </p>
              </div>
            </div>
            ...
            <div className="text-center">
              <Link
                href="/"
                className="inline-flex items-center text-primary-blue font-medium hover:text-primary-red transition-colors group"
              >
